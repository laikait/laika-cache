...
namespace Laika\Cache;

use Laika\Cache\Contracts\CacheDriverInterface;
use Laika\Cache\Driver\ArrayDriver;
use Laika\Cache\Driver\FileDriver;
use Laika\Cache\Driver\MemcachedDriver;
use Laika\Cache\Driver\RedisDriver;
use Laika\Cache\Exceptions\CacheException;
use Throwable;
...
class Cache
{
    ...
    protected function redisClient(): \Redis
    {
        ...
        $connection = 'Laika\\Core\\Storage\\Connection\\RedisConnection';
    ...
    protected function memcachedClient(): \Memcached
    {
        ...
        $connection = 'Laika\\Core\\Storage\\Connection\\MemcachedConnection';
